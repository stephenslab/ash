...
```{r egcdf-reduce, fig.height=3, fig.width=6, crop=TRUE, dev='pdf'}
...
```{r mean_cdf_nopen-reduce, fig.height=3, fig.width=6, crop=TRUE, dev='pdf'}
...
TO DO (maybe): Add more details here about this chunk?
...
plot_mean_cdf_with_npmle(1,PLOTMETHODS = c("truth","ash.hu"),
                         PLOTSCENARIOS = c("spiky","near-normal","flat-top","skew",
                                           "big-normal","bimodal")) + 
