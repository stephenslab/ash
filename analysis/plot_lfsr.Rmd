...
TO DO: Add note here about having to first run script to generate data sets
...
```{r plot_lfsr, dev='pdf', fig.width=9, fig.height=3, crop=TRUE}
...
```{r plot_lfdr, dev='pdf', fig.width=9, fig.height=3, crop=TRUE}
...
```{r plot_lfsr_s, dev='pdf', fig.width=9, fig.height=3, crop=TRUE}
...
```{r plot_lfsr_s_nn, dev='pdf', fig.width=9, fig.height=3, crop=TRUE}
