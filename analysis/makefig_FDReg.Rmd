...
Here's an example of how qvalue decomposes $p$ values into null and alternative components
```{r}
...
axis(side=1, labels=FALSE,tck=-0.01)
altnullhist(pval,res.ash$lfdr,main="ash",ncz=ncz,xaxt='n',cex.axis=0.8)
axis(side=1, labels=TRUE,tck=-0.01,cex.axis=0.8)
#mtext(side=1,"p values",line=2)
...
axis(side=1, labels=FALSE,tck=-0.01)
nullalthist(zscore,res.ash$lfdr,main="ash",ncz=ncz,xaxt='n',cex.axis=0.8,ylim=c(0,0.3),xlim=c(-6,6))
axis(side=1, labels=TRUE,tck=-0.01,cex.axis=0.8)
#mtext(side=1,"z scores",line=2)
