...
**Note:** I find it confusing that you are using the same colour scheme here as
above, but you are showing `log(s)`, whereas above you are showing `1/s`. It
seems that it would be better to reverse the colour scheme for the `pval_plot`
to better correspond to the above plots. –Peter
...
pval_plot = function (df)
  ...
  scale_colour_gradient2(midpoint = 0,low = "blue",
                         mid = "white",high = "red")
