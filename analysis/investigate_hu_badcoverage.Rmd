...
```{r}
  eg=load_example(dsc_shrink,42,"flat-top",method="ash.hu.s","../output/dsc-shrink-files/")
  eg$output$fitted.g
```
...
```{r}
  ...
  eg =load_example(dsc_shrink,seed = 39,method="ash.u.s",scenario="spiky","../output/dsc-shrink-files")
```
