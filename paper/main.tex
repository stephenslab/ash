...
in FDR analyses, yields more accurate inferences than existing methods provided that the UA holds.
...
This will be discussed further in Xing and Stephens (in preparation).) Code and instructions for reproducing analyses and figures in this paper are at
...
(\url{http://stephenslab.github.io/ash/analysis/check_mixfdr_lownoise.html}). Of course, we would not advocate the UA in settings where multi-modality is 
