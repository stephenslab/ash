...
(Replacing $\lfsr_j$ with $\lfdr_j$ in these definitions gives estimates for the usual $\FDR(\Gamma)$, and a $q$ value for each observation respectively.)
...
%In contrast, due to the UA, the alternative $z$ score distribution for \ashr is required to have a mode at 0, 
