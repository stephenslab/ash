...
add_named_scenarios(dsc_opt,c("spiky","near-normal","flat-top","skew",
                              "big-normal","bimodal"))

###### Add Methods #####

add_method(dsc_opt,"ash.u",ash.multiopt.wrapper,
           args = list(mixcompdist = "uniform",method = "shrink"))
add_method(dsc_opt,"ash.hu",ash.multiopt.wrapper,
           args = list(mixcompdist = "halfuniform",method = "shrink"))
add_method(dsc_opt,"ash.n",ash.multiopt.wrapper,
           args = list(mixcompdist = "normal",method = "shrink"))
