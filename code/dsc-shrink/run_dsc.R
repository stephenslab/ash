...
add_output_parser(dsc_shrink,"locfdr2pi0",locfdr2pi0_est,"locfdr_output","pi0_est_output")
add_output_parser(dsc_shrink,"qvalue2pi0",qvalue2pi0_est,"qvalue_output","pi0_est_output")
